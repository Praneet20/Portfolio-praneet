    ...
    <div>
        ...
        <Grid item xs={12} sm={8} md={6}>
            ...
            <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">This is my first project</Typography>
            </CardContent>
            <CardActions>
         ...
         <Grid item xs={12} sm={8} md={6}>
            ...
            <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">This is my second project</Typography>
            </CardContent>
            <CardActions>
                <Button size="small" color="primary">Share</Button>
                <Button size="small" color="primary">Live Demo</Button>
         ...
         <Grid item xs={12} sm={8} md={6}>
            ...
            <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">This is my third project</Typography>
            </CardContent>
            <CardActions>
                <Button size="small" color="primary">Share</Button>
                <Button size="small" color="primary">Live Demo</Button>
         ...
         <Grid item xs={12} sm={8} md={6}>
            ...
            <CardContent>
                ...
                <Typography variant="body2" color="textSecondary" component="p">This is my fourth project</Typography>
            </CardContent>
            <CardActions>
                <Button size="small" color="primary">Share</Button>
                <Button size="small" color="primary">Live Demo</Button>
